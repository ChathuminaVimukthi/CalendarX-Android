package com.example.calendar_x_main;
...
public class CalendarX extends LinearLayout {
    ...
    public CalendarX(Context context) {
        super(context);
        init(context);
    }

    public CalendarX(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public CalendarX(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context);
    }

    public CalendarX(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(Context context) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.calendarview_layout, this, true);
